...
--
GRANT ALL PRIVILEGES ON *.* TO `tifosi`@`%` IDENTIFIED BY PASSWORD '*11DC7392881FEA1F6533D01C6896A30B34031500' WITH GRANT OPTION;

GRANT ALL PRIVILEGES ON `tifosi`.* TO `tifosi`@`%` WITH GRANT OPTION;

GRANT ALL PRIVILEGES ON `tifosi\_%`.* TO `tifosi`@`%`;
